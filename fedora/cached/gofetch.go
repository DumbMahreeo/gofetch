...
func main() {
	...
	packages := do("cat", "/etc/packlist.cache")

	/*
	The file "/etc/packlist.cache" is generated by running
	dnf list installed | wc -l > /etc/packlist.cache

	I suggest putting it in your crontab
	*/
